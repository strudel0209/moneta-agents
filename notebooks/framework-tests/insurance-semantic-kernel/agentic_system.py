...
agent_query = ChatCompletionAgent(
        ...
        **Your Task:**
        ...
        - Provide information about policies, prices, coverages, terms and conditions, etc. offered by Zurich Insurance by using the provided function: 'search_products_terms_conditions'.
